...
| 18 | **No login throttling** (repeated wrong passwords). User deferred (2026-09-26). | Before any non-author account exists | security-reviewer + backend-engineer | `accounts/` login view |
